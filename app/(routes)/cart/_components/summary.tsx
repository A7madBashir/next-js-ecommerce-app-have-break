...
const Summary = () => {
  ...
  const [appearPaymentModal, setAppearPaymentModal] = useState(false);
  ...
  const onCheckout = async () => {
    ...
    setLoading(false);
    if (response.status == 200) setAppearPaymentModal(true);
  ...
  return (
    <>
      ...
      {appearPaymentModal && (
        <PaymentModal
          open={appearPaymentModal}
          close={() => setAppearPaymentModal(false)}
